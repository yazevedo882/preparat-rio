...
REGRA DE PRIORIDADE IMPORTANTE: muitas questões vêm com um texto de apoio (uma notícia, uma tirinha, um trecho literário), mas a PERGUNTA em si testa uma habilidade gramatical específica (ex: "assinale a alternativa em que a concordância verbal está correta", "identifique o conectivo que expressa oposição"). Nesses casos, classifique pelo assunto GRAMATICAL específico que a pergunta exige (ex: "Concordância verbal e nominal", "Classes gramaticais", "Pontuação", "Ortografia e acentuação") — NUNCA como "Interpretação textual" só porque existe um texto de apoio. Reserve "Interpretação textual" apenas para quando a pergunta pede o sentido geral do texto, a ideia central, a intenção do autor, ou uma inferência sobre o conteúdo — não para questões gramaticais que meramente usam um texto como pretexto.`
