      ...
      <div className="w-full max-w-md">
        ...
        {tela === 'filtros' && (
          <div className="bg-white border-2 border-slate-900 rounded-2xl p-5">
            ...
            <Link
              href="/cadastro"
              className="w-full mt-2 block text-center bg-white border-2 border-slate-900 text-slate-900 font-mono uppercase tracking-wider text-sm font-bold py-3 rounded-lg transition hover:bg-stone-50"
            >
              + Cadastrar questão
            </Link>
